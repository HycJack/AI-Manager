...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "skills.popular.hint": "Top 20 most installed on skills.sh",
    "skills.popular.official": "Official",
    "skills.popular.weekly": "8w",
    "skills.popular.github": "Open on GitHub",
    "skills.popular.refresh": "Refresh leaderboard",
    "skills.popular.loading": "Loading leaderboard…",
    "skills.repoPicker.title": "Install skills",
    "skills.repoPicker.subtitle": "Available in this repository",
    "skills.repoPicker.selected": "selected",
    "skills.repoPicker.install": "Install",
    "skills.repoPicker.all": "Select all",
    "skills.repoPicker.none": "Clear selection",
  ...
  zh: {
    ...
    "skills.noDesc": "无描述",
    "skills.popular": "热门",
    "skills.popular.hint": "skills.sh 全站安装量 Top 20",
    "skills.popular.official": "官方",
    "skills.popular.weekly": "8周",
    "skills.popular.github": "在 GitHub 打开",
    "skills.popular.refresh": "刷新热门榜",
    "skills.popular.loading": "正在加载热门榜…",
    "skills.repoPicker.title": "安装技能",
    "skills.repoPicker.subtitle": "该仓库提供的技能",
    "skills.repoPicker.selected": "已选择",
    "skills.repoPicker.install": "安装",
    "skills.repoPicker.all": "全选",
    "skills.repoPicker.none": "全不选",
