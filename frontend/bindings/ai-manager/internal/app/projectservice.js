 ...
 * @returns {$CancellablePromise<void>}
 */
export function EnsureProjectsFileExists() {
 ...
 * @param {string[]} names
 * @param {string} projectPath
 * @param {agents$0.InstallTarget[]} targets
 * @param {boolean} global
 * @returns {$CancellablePromise<void>}
 */
export function InstallSkills(names, projectPath, targets, global) {
 ...
 * @param {string} projectPath
 * @returns {$CancellablePromise<project$0.Installation[]>}
 */
export function ListInstallations(projectPath) {
    return $Call.ByID(22827492, projectPath).then(/** @type {($result: any) => any} */(($result) => {
 ...
 * @returns {$CancellablePromise<project$0.Project[]>}
 */
export function ListProjects() {
    return $Call.ByID(3774475349).then(/** @type {($result: any) => any} */(($result) => {
 ...
 * @param {string} projectPath
 * @param {string} name
 * @param {agents$0.InstallTarget} target
 * @returns {$CancellablePromise<void>}
 */
export function UninstallSkill(projectPath, name, target) {
