 ...
 */
export function LoadPrefs(): $CancellablePromise<$models.Preferences> {
    return $Call.ByID(210428201).then(($result: any) => {
 ...
 */
export function SavePrefs(prefs: $models.Preferences): $CancellablePromise<void> {
